...
let songs = [
    ...
    },    
    {
        ...
        // Lirik dengan timestamp dalam detik
        lyrics: [
            { time: 10, text: "Oh no, did I get too close?" },
            { time: 13, text: "Oh, did I almost see what's really on the inside?" },
            { time: 17, text: "All your insecurities" },
            { time: 19, text: "All the dirty laundry" },
            { time: 22, text: "Never made me blink one time" },
            { time: 25, text: "Unconditional, unconditionally" },
            { time: 28, text: "I will love you unconditionally" },
            { time: 31, text: "There is no fear now" },
            { time: 34, text: "Let go and just be free" },
            { time: 37, text: "I will love you unconditionally" },
            { time: 40, text: "So come just as you are to me" },
            { time: 43, text: "Don't need apologies" },
            { time: 45, text: "Know that you are worthy" },
            { time: 47, text: "I'll take your bad days with your good" },
            { time: 50, text: "Walk through the storm, I would" },
            { time: 52, text: "I'd do it all because I love you" },
            { time: 55, text: "I love you" },
            { time: 58, text: "Unconditional, unconditionally" },
            { time: 61, text: "I will love you unconditionally" },
            { time: 64, text: "There is no fear now" },
            { time: 67, text: "Let go and just be free" },
            { time: 70, text: "I will love you unconditionally" },
            { time: 73, text: "Oh no, did I get too close?" },
            { time: 76, text: "Oh, did I almost see what's really on the inside?" },
            { time: 80, text: "All your insecurities" },
            { time: 82, text: "All the dirty laundry" },
            { time: 85, text: "Never made me blink one time" }
        ]
    }
];
